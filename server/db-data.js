import {tap, pipe as _, toPairs, map, flatten, chain, fromPairs} from 'ramda'

export const COURSES = {

  1: {
    id: 1,
    description: 'Amazing paginator',
...
const double = n => chain(e => [
  e,
  [n + e[0], {
    ...e[1],
    id: n * 100 + e[1].id,
    seqNo: n * 100 + e[1].seqNo
    // courseId: n * 100 + e[1].courseId
  }]
])

export const ITEMS = _(
  toPairs,
  // double(29),
  // double(2*29),
  // double(3*29),
